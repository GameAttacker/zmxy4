...
function JIANCE() {
  ...
  // 核心校验闭包
  const _0x133ec6 = function () {
    let _0x53d82a = true;
    return function (_0x50bf02, _0x3560ab) {
      const _0x5b3648 = _0x53d82a ? function () {
        if (_0x3560ab) {
          const _0x3d002e = _0x3560ab.apply(_0x50bf02, arguments);
          _0x3560ab = null;
          return _0x3d002e;
        }
      } : function () {};
  ...
  const _0x1e3f36 = _0x133ec6(this, function () {
    let _0x35ee26;
    try {
      const _0x2912f2 = Function("return (function() {}.constructor(\"return this\")( ));");
      _0x35ee26 = _0x2912f2();
    } catch (_0x5c48b2) {
      _0x35ee26 = window;
    }
    ...
    // ==========================================
    // 关键修改点：直接判定验证通过，移除所有域名比对与约定的重定向逻辑
    // ==========================================
    let _0x4c2b9a = true; 
    
    // 原版中的 if (!_0x4c2b9a) { _0x35ee26.location.host = ... } 劫持跳转逻辑已彻底移除
  });
  ...
  try {
    ...
    // 修复原脚本中变量命名的潜在 Bug
    [_0x12543d].forEach(executeDetection);
