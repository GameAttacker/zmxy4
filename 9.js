if (typeof h5gg === "undefined" || typeof Query === "undefined" || !Query) {
  console.log("环境未就绪：缺少 h5gg 或 Query 对象");
  // 如果在 WebView 运行，也可以用 alert("请在 h5gg 环境中运行！");
} 
  // 这里可以放你原本紧接着初始化的 AppState 
  const AppState = {
